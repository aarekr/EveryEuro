...
class MonthsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create month" do
    assert_difference("Month.count") do
      post months_url, params: { month: { food: @month.food, income: @month.income, name: @month.name, rent: @month.rent, saving: @month.saving, year: @month.year } }
    end
  ...
  test "should update month" do
    patch month_url(@month), params: { month: { food: @month.food, income: @month.income, name: @month.name, rent: @month.rent, saving: @month.saving, year: @month.year } }
